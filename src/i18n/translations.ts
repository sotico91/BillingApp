...
export const translations = {
  en: {
    ...
    'home.quickHint': 'Your top habits (same category + amount). Up to 5 from the last 30 days.',
  ...
  es: {
    ...
    'home.quickHint': 'Tus hábitos (misma categoría + monto). Máximo 5 de los últimos 30 días.',
